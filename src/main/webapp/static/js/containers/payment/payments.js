...
+(function (RocoUtils) {
    ...
    vueIndex = new Vue({
        ...
        methods: {
            ...
            showModel: function (payment, isEdit) {
                ...
                $modal.on('shown.bs.modal', function () {
                    modal($modal, payment, isEdit);
                });

            },

            showDetail: function (payment) {
