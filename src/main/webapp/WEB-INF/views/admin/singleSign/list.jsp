	...
	<div class="ibox">
		<div class="ibox-content">
			<form id="searchForm" @submit.prevent="query">
				<div class="row">
					<label class="col-md-1 line-height34">分公司:</label>
					<div class="col-md-2">
						<select class="form-control" v-model="form.company" id="company"
							name="company" class="form-control">
							<option value="140" selected>北京</option>
						</select>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group" v-clickoutside="clickOut">
							<label class="sr-only"></label> <input v-model="form.orgName"
								@click="showOrgTree=true" readonly type="text"
							...
							<z-tree v-ref:nodes-select :nodes="orgData"
...
<script src="${ctx}/static/js/containers/singleSign/list.js"></script>