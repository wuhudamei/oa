                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input
                                        ...
                                        name="title"
                                        type="text"
                                        placeholder="信件标题" class="form-control"/>
                            </div>
                        </div>
                        <div class="col-md-2" v-if="form.readStatus">
                            <div class="form-group">
                                <select v-model="form.importantDegree"
                                        id="importantDegree"
...
<script src="/static/js/containers/chairmanMailbox/list.js"></script>
</body>
</html>