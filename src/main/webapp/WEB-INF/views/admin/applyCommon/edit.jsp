				...
				<div class="col-md-6">
					<div class="row">
						<div class="form-group">
							...
							<div class="col-md-9">
							<input readonly v-model="form.id"
									maxlength="20" name="id" id="id" 
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input readonly v-model="form.applyTime" maxlength="100"
									name="applyTime" type="text" class="form-control" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="form-group">
							...
							<label class="col-md-2 control-label"
								...
								<button type="button" class="btn btn-primary btn-outline" >上传照片</button> 
								</web-uploader>
							</label>
						</div>
					</div>
				...
				<div class="form-group">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr v-for="approve in approveList">
							...
							<td align="center"
								style="color: {{approve.approveResult| formatData 'css'">{{approve.approveResult
								| formatData 'result'}}</td>
...
<script src="${ctx}/static/js/containers/commonApply/edit.js"></script>
