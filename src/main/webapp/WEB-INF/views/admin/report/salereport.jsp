  ...
  <%@ taglib prefix="sitemesh" uri="http://www.opensymphony.com/sitemesh/decorator" %>
    ...
    <body>
      <div class="wrapper wrapper-content" id="container" v-cloak>
        <!--转单状况统计-->
        <div class="panel">
          <div class="panel-heading big-header">{{params.type === "shop" ? '进店报表' : '线索报表'}} <button class="pull-right" type="" @click="backList">主页</button><button class="pull-right" type="" @click="goBack">返回</button></div>
        </div>
        <div class="panel-body">
          <pie-chart :series="dayData" :hei="150">
            ...
            <dl class="week-month left" slot="content">
              ...
              <dd class="num-stl text-red" v-if="dayAmount">合计:&nbsp; <span class="num-stl">{{dayAmount}}</span></dd>
            </dl>
        ...
        <div class="panel-body">
          <pie-chart :show="true" :series="monthData" name="本月" :hei="150">
            <div class="reportBox" slot="title">
            ...
            <dl class="week-month left" slot="content">
              ...
              <dd class="num-stl text-red" v-if="allMonthData.totalAmount">合计:&nbsp; <span class="num-stl">{{allMonthData.totalAmount}}</span></dd>
      ...
      <script src="${ctx}/static/js/containers/report/salereport.js"></script>
    </body>
