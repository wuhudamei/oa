...
<div id="container" class="wrapper wrapper-content">
  ...
  <div class="ibox-content">
        ...
        <table  class="table-responsive" style="border: 0px solid #ddd;">
            <tr>
                <td>
                    <p>员工姓名：<span style="font-weight: bold;">{{salaryDetail==null?name:salaryDetail.empName}}</span></p>
                </td>
                <td >
                    <p>员工编号：<span style="font-weight: bold;">{{salaryDetail==null?account:salaryDetail.orgCode}}</span></p>
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr>
            ...
            <%--<tr>--%>
                <%--<td>--%>
                    <%--<p hidden="hidden">应出勤天数：<span style="font-weight: bold;color: #00a0e9;">{{salaryDetail==null?'0':salaryDetail.shouldWorkDays}}</span></p>--%>
                <%--</td>--%>
                <%--<td >--%>
                    <%--<p hidden="hidden">实际出勤天数：<span style="font-weight: bold;color: #00a0e9;">{{salaryDetail==null?'0':salaryDetail.practicalWorkDays}}</span></p>--%>
                <%--</td>--%>
            <%--</tr>--%>
            <%--<tr><td>&nbsp;</td></tr>--%>
            <tr>
        ...
        <table class="table-responsive" style="border: 0px solid #ddd;">
          <tr>
              ...
              <td>
                  <p>其他：<span style="font-weight: bold;color: #00B83F;">{{salaryDetail==null?'0':salaryDetail.otherSubsidyDn}}</span></p>
              </td>
          </tr>
        </table>
        <hr />
...
<script src="${ctx}/static/js/containers/salaryManagement/listMySala.js"></script>