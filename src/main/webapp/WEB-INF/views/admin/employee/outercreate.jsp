					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-md-9"
								...
								<input v-model="employee.orgCode"
									v-validate:orgcode="{
				                       required:{rule:true,message:'请输入员工编号'}, 
				                      maxlength:{rule:20,message:'员工编号最长不能超过5个字符'}
				                      }" 
									maxlength="5" name="orgCode" type="text" class="form-control" />
								<span v-cloak
				...
				<div class="col-md-6">
					<div class="row">
                      ...
                      email:{rule:true,message:'邮箱格式错误'}
									...
									maxlength="20" name="email" type="text" class="form-control" />
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<select v-model="employee.accountType" id="accountType"
									...
									<option value="EMPLOYEE" selected>内部账户</option>
...
<script src="${ctx}/static/js/containers/employee/outercreate.js?v=new Date()"></script>