    ...
    <div class="ibox-content">
      <div>
          <Tabs type="card"  @on-click="clickEvent">
			      ...
			      <table id="dataTableCmmon" width="100%" class="table table-striped table-bordered table-hover">
			      </table>
             </Tab-pane>
          	 <Tab-pane label="请假" v-if="1==2">
          	   <div class="row">
...
<script src="${ctx}/static/js/containers/processMonitored/monitored.js?v=1.01"></script>