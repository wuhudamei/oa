        ...
        <div class="ibox-content">
            <div>
                <Tabs type="card">
                    ...
                    <Tab-pane label="审批历史">
                        <div class="row">
                            <form id="searchForm2" @submit.prevent="queryHis">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="sr-only" for="keyword"></label>
                                        <input
...
<!-- 预算申请详情-->
<div id="detail" class="modal fade" tabindex="-1" data-width="760">
...
<script src="${ctx}/static/js/containers/signature/signatures.js?v=1.0"></script>
