...
<!-- 预算申请详情-->
<div id="detail" class="modal fade" tabindex="-1" data-width="900">
...
<!-- 预算审批详情-->
 <div id="multDetail" class="modal fade" tabindex="0" data-width="900"> 
     <div class="modal-header"> 
         <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
         <h3>预算申请详情</h3> 
     </div> 
     <div class="modal-body"> 
         <jsp:include page="multDetail.jsp"></jsp:include> 
     </div> 
     <div class="modal-footer"> 
         <button :disabled="disabled" type="button" data-dismiss="modal" class="btn">关闭</button> 
     </div> 
...
<script src="${ctx}/static/js/containers/budget/budgets.js?v=1.1"></script>
